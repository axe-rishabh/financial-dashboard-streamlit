...
# option = st.sidebar.selectbox("Which Dashboard?", ('twitter', 'wallstreetbets', 'stocktwits', 'chart', 'pattern'), 0)
option = st.sidebar.selectbox("Which Dashboard?", ('twitter', 'stocktwits'), 0)
